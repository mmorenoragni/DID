CREATE OR REPLACE PACKAGE BODY DDPK_ACTAS_DNID AS
  ...
  PROCEDURE DDSP_OBTENER_ACTA_NACIMIENTO(p_primer_apellido  IN VARCHAR2,
    ...
    OPEN p_recordset FOR
      SELECT N.NU_CUI,
       ...
       WHERE N.CO_ESTADO_ACTA_NACIMIENTO = '1'
         ...
         AND N.CO_NACIDO_NATURAL_DPTO = p_nac_nat_dpto
         AND N.CO_NACIDO_NATURAL_PROV = p_nac_nat_prov
         AND N.CO_NACIDO_NATURAL_DIST = p_nac_nat_dist
         AND N.CO_NACIDO_NATURAL_LOCA = p_nac_nat_loca;
