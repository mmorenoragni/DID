  ...
  BEGIN
    OPEN p_recordset FOR
      SELECT A.NU_DNI AS CUI_DNI,
             ...
             --
             DECODE(SUBSTR(U_NACI.CO_UBIGEO,1,8),'92-33-24', --Callao
                    SUBSTR(TRIM(REPLACE(NVL(U_NACI.DE_UBIGEO_CAPTU, U_NACI.DE_UBIGEO),
                                        '/',
                                        ' / ')),3),
             ...
             --
             DECODE(SUBSTR(U_DOM.CO_UBIGEO,1,8),'92-33-24', --Callao
                    SUBSTR(TRIM(REPLACE(NVL(U_DOM.DE_UBIGEO_CAPTU, U_DOM.DE_UBIGEO),
                                        '/',
                                        ' / ')),3),
             ...
             OBS.CO_OBS_DNI AS OBSERVACIONES,
        ...
        LEFT JOIN IDOTABMAESTRA.GEVW_UBIGEOS U_NACI
          ON U_NACI.CO_CONTINENTE = A.CO_CONTINENTE_NACI
         AND U_NACI.CO_PAIS = A.CO_PAIS_NACI
         AND U_NACI.CO_DEPARTAMENTO = A.CO_DEPARTAMENTO_NACI
        ...
        LEFT JOIN IDOTABMAESTRA.GEVW_UBIGEOS U_DOM
          ON U_DOM.CO_CONTINENTE = A.CO_CONTINENTE_DOMICILIO
         AND U_DOM.CO_PAIS = A.CO_PAIS_DOMICILIO
         AND U_DOM.CO_DEPARTAMENTO = A.CO_DEPARTAMENTO_DOMICILIO
        ...
        LEFT JOIN IDOIMPRESION.IMTC_DNIS_IMPRESION OBS
        ON OBS.NU_FICHA_REG = A.NU_FICHA_REG
        AND OBS.TI_DOC_REG = A.TI_FICHA_REG
