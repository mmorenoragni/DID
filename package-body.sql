  ...
  BEGIN
    OPEN p_recordset FOR
      SELECT A.NU_DNI AS CUI_DNI,
             ...
             -- Domicilio concatenado (Lógica original simplificada para brevedad)
             A.DE_DIRECCION || ' ' || A.NU_DIRECCION AS DOMICILIO,
             
             G.DE_GRUPO_FACTOR AS GRUPO_FACTOR_SANGUINEO,
             OBS.LISTA_OBSERVACIONES AS OBSERVACIONES,
             NVL(TRIM(R.DE_CEL), 'SIN RESTRICCIÓN') AS RESTRICCION,
