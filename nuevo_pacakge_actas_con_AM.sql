    ...
    open p_recordset for
      select M.FE_DE_CELEBRACION,
        ...
        left join IDORRCC.RCTM_ESCANEO I
         ...
         left join IDORRCC.GEVW_UBIGEOS U on U.CO_CONTINENTE=M.CO_CELEBRADO_CONT and U.CO_PAIS=M.CO_CELEBRADO_PAIS and U.CO_DEPARTAMENTO=M.CO_CELEBRADO_DPTO and U.CO_PROVINCIA=M.CO_CELEBRADO_PROV and U.CO_DISTRITO=M.CO_CELEBRADO_DIST and U.CO_CENTRO_POBLADO_O=M.CO_CELEBRADO_LOCA
